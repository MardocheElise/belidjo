...
export default function VendorDashboard() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!imageFile && !formData.img) {
        throw new Error("Vous devez importer une image ou fournir une URL");
      }
      ...
      setSuccess("✅ Produit ajouté avec succès ! Redirection...");
      ...
      // ✅ CORRECTION : Redirection immédiate et fiable sur mobile
      // Utilisation de window.location au lieu de setTimeout + router.push
      setTimeout(() => {
